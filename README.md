...
The chatbot analyzes the user's request and generates relevant recipe suggestions, including ingredients, preparation steps, cooking instructions, and helpful tips.
...
* To help users understand cooking procedures step by step.
* To reduce the time required to search for suitable recipes.
...
**User:**
I have tomato, onion, and bread. What can I make?

**AI Recipe Chatbot:**
You can make a quick **Tomato Bread Toast**.
...
2. Mix them with salt and pepper.
3. Spread the mixture over the bread.
4. Toast until crispy and golden.
5. Serve hot.
...
**User:**
How can I make vegetable fried rice?

**AI Recipe Chatbot:**
The chatbot provides the required ingredients, preparation steps, cooking instructions, and useful cooking tips for making vegetable fried rice.

---

### Example 3 – Ingredient Substitution

**User:**
I don't have milk. What can I use instead?

**AI Recipe Chatbot:**
The chatbot suggests suitable alternatives such as yogurt, coconut milk, soy milk, or other appropriate substitutes depending on the recipe.

---

### Example 4 – Cooking Guidance

**User:**
How long should I cook pasta?

**AI Recipe Chatbot:**
The chatbot provides cooking-time guidance and explains how to check whether the pasta is properly cooked.
...
**AI Recipe Chatbot:**
Yes. The chatbot suggests suitable alternatives or explains how the recipe can be prepared without onion.

---

### 💬 Sample User Queries

Users can interact with the chatbot using queries such as:

* "What can I make with potatoes and eggs?"
...
User Input
    ↓
Enter Ingredients / Recipe Request
    ↓
Chatbot Processes the Query
    ↓
AI / LLM Understands User Intent
    ↓
Recipe Generation
    ↓
Ingredients + Cooking Steps + Tips
    ↓
...
2. **Query Processing**
   The application receives the user's message and processes the natural-language request.

3. **AI Understanding**
   The AI model understands the user's requirements, ingredients, and recipe preferences.

4. **Recipe Generation**
   Based on the request, the AI generates a suitable recipe with ingredients and preparation instructions.

5. **Response Generation**
   The chatbot presents the recipe in a clear and structured format.
...
* **Generative AI / LLM** – Used for understanding queries and generating recipe responses.
* **Hugging Face Transformers** – Used for working with AI/LLM models.
...
This project provides a strong foundation for developing more advanced AI-powered applications with features such as personalization, image recognition, nutrition analysis, and voice interaction.
